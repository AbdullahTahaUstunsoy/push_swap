...
void ft_control3(int is_num_flag , int is_exist_flag, char **args){
    ...
    free_args(args); //args ile is_in_range flag'imizi de aldık ve args ile args ile args[i]'leri free'leyedik.
                // printf("%d , %d , %d",is_num_flag,is_exist_flag,is_in_range_flag); 
